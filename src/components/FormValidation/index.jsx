...
const Index = () => {
  ...
  const onSubmit = (data) => {
    ...
    finalValues["allFiles"] = uploadFile;

    if (checkValue === true) {
      data.permanentAddress1 = data.residenceAddress1;
      data.permanentAddress2 = data.residenceAddress2;
    }
    delete(finalValues.file);
    delete(finalValues.filename)
    delete(finalValues.filetype)
    console.log({ data });
          ...
          <div className='grid grid-cols-2 gap-4 ml-24'>
            <div className='mb-4'>
              ...
              <input
                className='shadow appearance-none border rounded w-4/6 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
                {...register(
                  checkValue ? "residenceAddress1" : "permanentAddress1"
                )}
                disabled={checkValue}
                placeholder='Please Enter Address'
              />
            ...
            <div className='mb-4'>
              ...
              <input
                className='shadow appearance-none border rounded w-4/6 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
                {...register(
                  checkValue ? "residenceAddress2" : "permanentAddress2"
                )}
                disabled={checkValue}
                placeholder='Please Enter Address'
              />
          ...
          {uploadFile.length > 0
            ? uploadFile?.map((item, ind) => {
                return (
                  <div
                    key={ind}
                    className='grid grid-cols-4 gap-4 text-center ml-20'
                  >
                          ...
                          render={({ field, fieldState }) => (
                            <>
                              ...
                              <input
                                ...
                                id='fileName'
                                onChange={(event) =>
                                  field.onChange(setDocument(event, ind))
                                }
                              />
                          ...
                          render={({ field, fieldState }) => (
                            <>
                              ...
                              <input
                                ...
                                id='file'
                                onChange={(event) =>
                                  field.onChange(setDocumentFile(event, ind))
                                }
                              />
